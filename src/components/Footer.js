...
export default function Footer() {
    ...
    // Mostrar cookies solo si no se ha aceptado/rechazado
    useEffect(() => {
    ...
    return (
        <footer id='footer'>
            ...
            {modal === 'cookies' && showCookies && (
                <div className="modal-bg" onClick={handleClose}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        <img src={cruz} className="close-modal" onClick={handleClose} alt='cruz' />
                        <div>
                            ...
                            <div className="botones-footer-modal">
                                <button className="botonFooter" onClick={handleAcceptCookies}>Aceptar</button>
                                <button className="botonFooter" onClick={handleRejectCookies}>Rechazar</button>
                            </div>
                        </div>
                    </div>
                </div>
